 ...
 * 
 */
public class OWLClassExpressionVisitorImpl2 implements
	...
	/**
		 * 
		 */
	public OWLClassExpressionVisitorImpl2(Term glueVariable) {
	...
	public LogicalFormula visit(OWLObjectSomeValuesFrom arg) {
		...
		LogicalFormula f = arg.getFiller().accept(
				new OWLClassExpressionVisitorImpl2(newGlueVariable));
	...
	public LogicalFormula visit(OWLObjectHasValue arg) {
		...
		Atom a = createAtom(property, glueVariable, createTerm(arg.getValue()));
		return this.createLogicalFormula(a);
	}
	...
	public LogicalFormula visit(OWLDataHasValue arg) {
		Predicate property = createPredicate(arg.getProperty());
		Atom a = createAtom(property, glueVariable, new Term(arg.getValue().toString(), Term.Type.LITERAL));
		return this.createLogicalFormula(a);
	}
