...
public class OWL2ParserTest {
	...
	private static final Predicate A = new Predicate(new DefaultURI(test, "A"),
			1);
	private static final Predicate B = new Predicate(new DefaultURI(test, "B"),
			1);
	private static final Predicate C = new Predicate(new DefaultURI(test, "C"),
			1);
	private static final Predicate D = new Predicate(new DefaultURI(test, "D"),
			1);

	private static final Predicate P = new Predicate(new DefaultURI(test, "p"),
			2);
	private static final Predicate Q = new Predicate(new DefaultURI(test, "q"),
			2);
	private static final Predicate R = new Predicate(new DefaultURI(test, "r"),
			2);
	private static final Predicate S = new Predicate(new DefaultURI(test, "s"),
			2);

	private static final Constant I1 = DefaultTermFactory.instance()
			.createConstant(new DefaultURI(test, "i1"));

	private static final Constant I2 = DefaultTermFactory.instance()
			.createConstant(new DefaultURI(test, "i2"));

	private static final Constant I3 = DefaultTermFactory.instance()
			.createConstant(new DefaultURI(test, "i3"));

	private static final Literal L1 = DefaultTermFactory
			.instance()
			.createLiteral(new DefaultURI(Prefix.XSD.getPrefix(), "integer"), 7);
	...
	public void subClassOfAxiom() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + ":A rdf:type owl:Class . "
				+ ":B rdf:type owl:Class . " + ":A rdfs:subClassOf :B. ");
	...
	public void equivalentClassAxiom() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + ":A rdf:type owl:Class . "
				+ ":B rdf:type owl:Class . " + ":A owl:equivalentClass :B. ");
		...
		for (Object o : parser) {
			if (o instanceof Rule) {
				...
				Assert.assertTrue(!body.getTerm(0).isConstant());
				Assert.assertTrue(body.getTerm(0).equals(head.getTerm(0)));
				Assert.assertTrue(A.equals(body.getPredicate())
						|| B.equals(body.getPredicate()));
				Assert.assertTrue(A.equals(head.getPredicate())
						|| B.equals(head.getPredicate()));
	...
	public void disjointClassAxiom() throws OWL2ParserException {
		...
		for (Object o : parser) {
			if (o instanceof NegativeConstraint) {
				...
				Assert.assertTrue(A.equals(body1.getPredicate())
						|| B.equals(body1.getPredicate())
						|| C.equals(body1.getPredicate()));
				Assert.assertTrue(A.equals(body2.getPredicate())
						|| B.equals(body2.getPredicate())
						|| C.equals(body2.getPredicate()));
			}
		}

		Assert.assertEquals("Number of assertions found:", 3,
				nbNegativeConstraint);
	}
	...
	public void objectIntersectionOf() throws OWL2ParserException {
		...
		for (Object o : parser) {
			if (o instanceof Rule) {
				...
				Assert.assertTrue(body.getTerm(0).equals(head.getTerm(0)));
				Assert.assertEquals(A, body.getPredicate());
				Assert.assertTrue(B.equals(head.getPredicate())
						|| C.equals(head.getPredicate())
						|| D.equals(head.getPredicate()));
	...
	public void objectSomeValuesFrom() throws OWL2ParserException {
		...
		for (Object o : parser) {
			if (o instanceof Rule) {
				...
				Assert.assertTrue(A.equals(body1.getPredicate())
						|| A.equals(body2.getPredicate()));
				Assert.assertTrue(P.equals(body1.getPredicate())
						|| P.equals(body2.getPredicate()));
				Assert.assertTrue(A.equals(body1.getPredicate())
						|| P.equals(body1.getPredicate()));
				Assert.assertTrue(A.equals(body2.getPredicate())
						|| P.equals(body2.getPredicate()));
	...
	public void objectMinCardinality0() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + ":A rdf:type owl:Class . "
				...
				+ " [ rdf:type owl:Restriction ; " + " owl:onProperty :p ; "
				+ " owl:onClass :A ; " + " owl:minCardinality 0 ] " + "  "
				+ " rdfs:subClassOf :B . ");
	...
	@Test
	public void objectMinCardinality0InRightHandSide()
			throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + ":A rdf:type owl:Class . "
				+ ":B rdf:type owl:Class . "
				+ ":p rdf:type owl:ObjectProperty . "
				+ " :B rdfs:subClassOf [ rdf:type owl:Restriction ; "
				+ " owl:onProperty :p ; " + " owl:onClass :A ; "
	...
	@Test
	public void complexObjectMinCardinality0InRightHandSide()
			throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + ":A rdf:type owl:Class . "
				+ ":B rdf:type owl:Class . "
				+ ":p rdf:type owl:ObjectProperty . "
	...
	public void objectMinCardinality1() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + ":A rdf:type owl:Class . "
				...
				+ ":p rdf:type owl:ObjectProperty . "
				+ " [ rdf:type owl:Restriction ; " + " owl:onProperty :p ; "
				+ " owl:onClass :A ; " + " owl:minCardinality 1 ] " + "  "
				+ " rdfs:subClassOf :B . ");
	...
	public void objectMaxCardinality0() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + ":A rdf:type owl:Class . "
				...
				+ " owl:onProperty :p ; " + " owl:onClass :B ; "
	...
	public void objectOneOf1() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + ":A rdf:type owl:Class . "
				+ " [ owl:oneOf ( :i1 ) ] " + " rdfs:subClassOf :A . ");
		...
		for (Object o : parser) {
			if (o instanceof AtomSet) {
				...
				AtomSet a = (AtomSet) o;
				Iterator<Atom> bodyIt = a.iterator();
				Assert.assertTrue(bodyIt.hasNext());
	...
	public void objectUnionOf() throws OWL2ParserException {
		...
		for (Object o : parser) {
			if (o instanceof Rule) {
				...
				Assert.assertTrue(body.getTerm(0).equals(head.getTerm(0)));
				Assert.assertEquals(A, head.getPredicate());
				Assert.assertTrue(B.equals(body.getPredicate())
						|| C.equals(body.getPredicate())
						|| D.equals(body.getPredicate()));
	...
	public void intersectionOfUnion() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(
				PREFIXES
	...
	public void example6() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + ":A rdf:type owl:Class . "
				...
				+ ":p rdf:type owl:ObjectProperty . "
				+ ":q rdf:type owl:ObjectProperty . "
				+ ":r rdf:type owl:ObjectProperty . " + "[owl:unionOf ("
				+ "		[owl:oneOf ( :i )] " + "		[rdf:type owl:Restriction ;"
				+ "			owl:onProperty :p ;" + "			owl:someValuesFrom :A]"
				+ "	)] " + "	rdfs:subClassOf " + "[owl:intersectionOf ( "
				+ "		[rdf:type owl:Restriction ;" + "			owl:onProperty :q ;"
				+ "			owl:someValuesFrom :B]" + "		[owl:complementOf :C ] "
				+ "		[rdf:type owl:Restriction ;" + "			owl:onProperty :r ;"
				+ "			owl:allValuesFrom :D]" + "	)] . ");
	...
	public void hasKeyWithUnion() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + ":A a owl:Class . "
						+ ":B a owl:Class . "
				+ ":p a owl:ObjectProperty . " + ":q a owl:DatatypeProperty . "
		...
		try {
			...
			for (Object o : parser) {
				if (o instanceof Rule) {
					...
					Assert.assertEquals(subProperty.getTerm(0),
							property.getTerm(0));
					Assert.assertEquals(subProperty.getTerm(1),
							property.getTerm(1));
				}
			}
		...
		try {
			...
			for (Object o : parser) {
				if (o instanceof Rule) {
					...
					Assert.assertTrue(Q.equals(property.getPredicate())
							|| P.equals(property.getPredicate()));
					Assert.assertTrue(Q.equals(subProperty.getPredicate())
							|| P.equals(subProperty.getPredicate()));

					Assert.assertEquals(property.getTerm(0),
							subProperty.getTerm(0));
					Assert.assertEquals(property.getTerm(1),
							subProperty.getTerm(1));
				}
			}
		...
		try {
			...
			for (Object o : parser) {
				if (o instanceof Rule) {
					...
					Assert.assertTrue(P.equals(a1.getPredicate())
							|| Q.equals(a1.getPredicate()));
					Assert.assertTrue(P.equals(a2.getPredicate())
							|| Q.equals(a2.getPredicate()));
					Assert.assertTrue(P.equals(a2.getPredicate())
							|| P.equals(a1.getPredicate()));
					Assert.assertTrue(Q.equals(a2.getPredicate())
							|| Q.equals(a1.getPredicate()));
		...
		try {
			...
			for (Object o : parser) {
				if (o instanceof Rule) {
					...
					Assert.assertTrue(b1.getTerm(1).equals(h.getTerm(0))
							|| b1.getTerm(1).equals(h.getTerm(1)));
					Assert.assertTrue(b2.getTerm(1).equals(h.getTerm(0))
							|| b2.getTerm(1).equals(h.getTerm(1)));
		...
		try {
			...
			for (Object o : parser) {
				if (o instanceof Rule) {
					...
					Assert.assertTrue(b1.getTerm(0).equals(h.getTerm(0))
							|| b1.getTerm(0).equals(h.getTerm(1)));
					Assert.assertTrue(b2.getTerm(0).equals(h.getTerm(0))
							|| b2.getTerm(0).equals(h.getTerm(1)));
		...
		try {
			...
			for (Object o : parser) {
				if (o instanceof Rule) {
					...
					Assert.assertTrue(b1.getTerm(0).equals(b2.getTerm(1))
							|| b1.getTerm(1).equals(b2.getTerm(0)));
					Assert.assertTrue(h.getTerm(0).equals(b1.getTerm(0))
							|| h.getTerm(0).equals(b2.getTerm(0)));
					Assert.assertTrue(h.getTerm(1).equals(b1.getTerm(1))
							|| h.getTerm(1).equals(b2.getTerm(1)));
				}
			}
	...
	public void objectPropertyRange() {
		...
		try {
			OWL2Parser parser = new OWL2Parser(PREFIXES
					+ ":p rdf:type owl:ObjectProperty . "
					+ ":A rdf:type owl:Class . " + ":p rdfs:range :A .");
	...
	public void objectPropertyDomain() {
		...
		try {
			OWL2Parser parser = new OWL2Parser(PREFIXES
					+ ":p rdf:type owl:ObjectProperty . "
					+ ":A rdf:type owl:Class . " + ":p rdfs:domain :A .");
	...
	@Test
	public void complexDataMinCardinality0InRightHandSide()
			throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(
				PREFIXES
						...
						+ ":p rdf:type owl:DatatypeProperty . "
						+ " :B rdfs:subClassOf [a owl:Restriction; owl:onProperty :p; owl:someValuesFrom [ rdf:type owl:Restriction ; "
						+ " owl:onProperty :p ; " + " owl:onDataRange :D ; "
						+ " owl:minCardinality 0 ] ]. ");
	...
	public void dataMinCardinality1() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES
				...
				+ ":p rdf:type owl:DatatypeProperty . "
				+ " [ rdf:type owl:Restriction ; " + " owl:onProperty :p ; "
				+ " owl:onDataRange :D ; " + " owl:minCardinality 1 ] " + "  "
				+ " rdfs:subClassOf :B . ");
		...
		for (Object o : parser) {
			if (o instanceof Rule) {
				...
				Assert.assertTrue(D.equals(body1.getPredicate())
						|| D.equals(body2.getPredicate()));
				Assert.assertTrue(P.equals(body1.getPredicate())
						|| P.equals(body2.getPredicate()));
				Assert.assertTrue(D.equals(body1.getPredicate())
						|| P.equals(body1.getPredicate()));
				Assert.assertTrue(D.equals(body2.getPredicate())
						|| P.equals(body2.getPredicate()));
	...
	public void dataMaxCardinality0() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + ":A rdf:type owl:Class . "
				...
				+ ":p rdf:type owl:DatatypeProperty . "
				+ " :A rdfs:subClassOf [ rdf:type owl:Restriction ; "
				+ " owl:onProperty :p ; " + " owl:onDataRange :B ; "
				+ " owl:maxCardinality 0 ] . ");
	...
	public void dataPropertyDomainAxiom() throws OWL2ParserException {
		...
		OWL2Parser parser = new OWL2Parser(PREFIXES
				+ ":p rdf:type owl:DatatypeProperty . "
				+ ":C rdf:type owl:Class ." + ":p rdfs:domain :C .");
	...
	public void dataPropertyRangeAxiom() throws OWL2ParserException {
		...
		OWL2Parser parser = new OWL2Parser(PREFIXES
				+ ":p rdf:type owl:DatatypeProperty . "
				+ ":D rdf:type rdfs:Datatype ." + ":p rdfs:range :D .");
	...
	@Test
	public void complexDataPropertyRangeAxiomWithIntersection()
			throws OWL2ParserException {
		// D(Y) :- p(X, Y).
		OWL2Parser parser = new OWL2Parser(PREFIXES
				+ ":p rdf:type owl:DatatypeProperty . "
	...
	@Test
	public void complexDataPropertyRangeAxiomWithComplementOf()
			throws OWL2ParserException {
		// D(Y) :- p(X, Y).
		OWL2Parser parser = new OWL2Parser(PREFIXES
				+ ":p rdf:type owl:DatatypeProperty . "
	...
	@Test
	public void complexDataPropertyRangeAxiomWithOneOf()
			throws OWL2ParserException {
		// D(Y) :- p(X, Y).
		OWL2Parser parser = new OWL2Parser(PREFIXES
				+ ":p rdf:type owl:DatatypeProperty . "
				+ ":p rdfs:range [owl:complementOf [owl:oneOf ( :i1 :i2 ) ]] .");
	...
	public void objectPropertyChain() throws OWL2ParserException {
		...
		for (Object o : parser) {
			if (o instanceof Rule) {
				...
				Assert.assertTrue(P.equals(body1.getPredicate())
						|| Q.equals(body1.getPredicate())
						|| R.equals(body1.getPredicate()));
				Assert.assertTrue(P.equals(body2.getPredicate())
						|| Q.equals(body2.getPredicate())
						|| R.equals(body2.getPredicate()));
				Assert.assertTrue(P.equals(body3.getPredicate())
						|| Q.equals(body3.getPredicate())
						|| R.equals(body3.getPredicate()));
	...
	public void classAssertion() throws OWL2ParserException {
		...
		for (Object o : parser) {
			if ((o instanceof AtomSet)) {
				++nbFacts;
				Iterator<Atom> it = ((AtomSet) o).iterator();
	...
	public void assertionObjectProperty() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES
				+ ":p rdf:type owl:ObjectProperty . " + ":i1 :p :i2 ." + "");
	...
	@Test
	public void assertionDataProperty() throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES
				+ ":p rdf:type owl:DatatypeProperty . " + ":i1 :p 7 ." + "");
	...
	@Test
	public void illegalAllValuesFromMaskedSomeValuesFrom()
			throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + " :A a owl:Class. "
				+ ":B a owl:Class. "
				+ ":p a owl:ObjectProperty. " + "[rdf:type owl:Restriction; "
				+ "    owl:onProperty :p; "
				+ "    owl:someValuesFrom [rdf:type owl:Restriction; "
				+ "        owl:onProperty :p ; "
				+ "        owl:allValuesFrom :A] " + "] rdfs:subClassOf :B .");
	...
	@Test
	public void illegalAllValuesFromMaskedInIntersection()
			throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(PREFIXES + " :A a owl:Class. "
	...
	@Test
	public void intersectionOfIntersectionOfIntersection()
			throws OWL2ParserException {
		OWL2Parser parser = new OWL2Parser(
				PREFIXES
						+ " :A a owl:Class. "
