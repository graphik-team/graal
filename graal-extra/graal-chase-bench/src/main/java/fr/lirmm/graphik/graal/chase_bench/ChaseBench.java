...
public class ChaseBench {
	...
	public static void main(String args[]) throws ChaseException, AtomSetException, IOException, HomomorphismException {
		...
		Chase chase = new DefaultChase(stTgdsSet, atomSet);
		chase.setProfiler(prof);
		chase.execute();
