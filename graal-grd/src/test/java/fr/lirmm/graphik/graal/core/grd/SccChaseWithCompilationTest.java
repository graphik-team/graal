...
public class SccChaseWithCompilationTest {

	private void checkResult(InMemoryAtomSet result, InMemoryAtomSet expected) throws AtomSetException, HomomorphismException {
	...
	public void oneCompilationSimple() throws Exception {
		...
		Chase chase = new SccChase<AtomSet>(onto.iterator(), atoms, compilation);
		chase.execute();
