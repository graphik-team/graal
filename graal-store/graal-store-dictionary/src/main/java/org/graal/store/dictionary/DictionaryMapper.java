...
public abstract class DictionaryMapper extends AbstractMapper implements DictionaryMapping, TermMapper{
	 ...
	 * identifiers[0,existentialBeginIdx[ contains URI of terms and predicate identifiers
	 * identifiers[existentialBeginIdx,|identifiers|] contains existential var identifiers
	 */
...
//		predicateTypes = new HashMap<>();
	...
	/**
	 * Return the list of mapped predicates
	 * Complexity O(1)
	 */
	...
	/**
	 * @return the list of unmapped predicates
	 * Complexity O(n) with n predicate into dictionary
	 */
	...
	/**
	 * Return the list of all mapped terms
	 * Complexity O(1)
	 */
	...
	/**
	 * @return the list of unmapped terms
	 * Complexity O(n) with n term into dictionary
	 */
	...
	public Term unmap(Term term) {
		...
		if(identifier instanceof Integer) {
			...
			return datatype == CONSTANT_TERM ? 
					termFactory.createConstant(termURI) : termFactory.createConstant(new DefaultURI(termURI));		
		}
		return term;
	}
	...
	/**
	 * Add a existential variable to the dictionary
	 * You should use this method to insert existential term
	 * @param term
	 */
	...
	/**
	 * Add a list of existential variables to the dictionary
	 * You should use this method to insert existential terms
